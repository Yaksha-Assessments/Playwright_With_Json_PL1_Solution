...
export default class AppointmentPage {
   ...
   *
   * @description This method checks whether the passed patient name appears in the search results under the 'ShortName'
   *              column. Patient name must be fetched from testData.json file. It waits for the column to be visible, retrieves the list of displayed names, and verifies that the
